...
public class PostsApiControllerTest {
    ...
    @Before // 매번 테스트가 시작되기 전에 MockMvc 인스턴스를 생성힘.
    public void setup() {
        mvc = MockMvcBuilders
    ...
    public void Posts_등록된다() throws Exception {
        ...
        //when
        // mvc.perform
        // 생성된 MockMvc를 통해 API를 테스트 한다, 본문(body) 영역은 문자열로 표현하기 위해 ObjectMapper를 통해 문자열 JSON으로 변환한다.
...
//    @Test
//    // @WithMockUser(roles = "USER")
//    // 인증된 모의(가짜) 사용자를 만들어서 사용, role에 권한을 추가할 수 있다.
